...
def webpage():
    ...
    <body>
        ...
        <script>
            const data = {{
                labels: ['TVOC', 'Humidity', 'Temp (AHT20)', 'Temp (BMP280)'],
                datasets: [{{
                    label: 'Sensor Data',
                    data: [{tvoc}, {humidity:.2f}, {temperature_aht20:.2f}, {temperature_bmp280:.2f}],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
                        'rgba(75, 192, 192, 0.2)',
